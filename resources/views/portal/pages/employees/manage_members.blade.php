              ...
              <div class="row">
                ...
                <div class="col col-3">
                  <select id="searchBy" class="form-control form-control-sm select2">
                    <option value="{{ route('member.search', 'username') }}" selected="selected">Username</option>
                    <option value="{{ route('member.search', 'email') }}">Email</option>
                  </select>
                </div>
                <!-- /.col -->
              </div>
          ...
          <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <div class="btn-group">
                          <button onclick="window.location.href = '/member/id/{{ Crypt::encrypt($def->id) }}/edit';" type="button" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></button>
                          <button type="button" class="btn btn-sm btn-danger" data-id="/member/id/{{ Crypt::encrypt($def->id) }}/destroy" data-name="{{ $def->username }}" data-toggle="modal" data-target="#remove"><i class="far fa-trash-alt"></i></button>
