        ...
        <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <!-- /.col -->
                <form action="{{ route('customerfree.search', 'username') }}" id="search">
                <div class="col">
                ...
                <div class="col col-3">
                  <select id="searchBy" class="form-control form-control-sm select2">
                    <option value="{{ route('customerfree.search', 'username') }}" selected="selected">Name</option>
                    <option value="{{ route('customerfree.search', 'email') }}">Email</option>
                  </select>
                </div>
                <!-- /.col -->
              </div>
