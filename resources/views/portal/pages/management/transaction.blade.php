                ...
                <div class="col">
                  <ul class="nav">
                    <li class="nav-item mr-2">
                        <button onclick="window.location.href = '{{ route('transaction.add') }}';" type="button" class="btn btn-sm btn-primary">
              ...
              <table class="table table-bordered mt-2">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                        <button class="btn btn-sm btn-outline-primary">Show Details</button>
                    </td>
                    <td class="text-center">
                      <div class="btn-group">
                          <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#remove-trx"><i class="fas fa-trash-alt"></i></button>
                      </div>
                    </td>
                  </tr>
                </tbody>
