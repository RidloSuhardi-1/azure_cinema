...
@section('title', 'Register to Azure')
...
<div class="register-box m-5">
  <div class="card card-outline card-primary">
    ...
    <form action="{{ route('consumer.register.process') }}" method="POST">
        @csrf
      ...
      <hr>
        ...
        <a href="{{ route('consumer.login') }}" class="float-right">Already have an account</a>
