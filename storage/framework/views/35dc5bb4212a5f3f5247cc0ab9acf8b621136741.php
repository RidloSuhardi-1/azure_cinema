    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo e(route('customers')); ?>">Customers</a></li>
                </ol>
            </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <ul class="nav">
                    <li class="nav-item mr-2">
                        <button onclick="location.href = '<?php echo e(route('customers.print')); ?>';" type="button" class="btn btn-sm btn-success">
                ...
                <form action="<?php echo e(route('customer.search', 'username')); ?>" id="search">
                    <div class="col">
              ...
              <table class="table table-bordered mt-2">
                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $def): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td>
                        <span class="badge <?php echo e($def->label == 'Free' ? 'bg-primary' : 'bg-warning'); ?>">
                            <?php echo e($def->label); ?> Customer
                        </span>
                    </td>
                    <td class="text-center">
                      <div class="btn-group">
                          ...
                          <button type="button" class="btn btn-sm btn-danger" data-id="<?php echo e(route('customer.destroy', Crypt::encrypt($def->id))); ?>" data-name="<?php echo e($def->username); ?>" data-toggle="modal" data-target="#remove"><i class="far fa-trash-alt"></i></button>
                      </div>
                    </td>
                  </tr>
...
<?php echo $__env->make('portal.master.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\azure_cinema\resources\views/portal/pages/customers/manage_customers.blade.php ENDPATH**/ ?>