<?php $__env->startSection('title', 'Manage Waiting Members'); ?>
    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Waiting to Approve</li>
                </ol>
            </div>
            </div>
        </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Members Approval List</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div class="row">
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <div class="btn btn-group">
                      <button type="submit" class="btn btn-danger mr-1">Decline</button>
...
<?php echo $__env->make('portal.master.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\azure_cinema\resources\views/portal/pages/waiting_members.blade.php ENDPATH**/ ?>