<?php $__env->startSection('title', 'Manage Premium Customers'); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <form action="<?php echo e(route('customer.free.search', 'username')); ?>" id="search">
                    <div class="col">
                ...
                <div class="col col-3">
                  <select id="searchBy" class="form-control form-control-sm select2">
                    <option value="<?php echo e(route('customer.free.search', 'username')); ?>" selected="selected">Username</option>
                    <option value="<?php echo e(route('customer.free.search', 'email')); ?>">Email</option>
                  </select>
                </div>
                <!-- /.col -->
              </div>
...
<?php echo $__env->make('portal.master.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\azure_cinema\resources\views/portal/pages/customers/premium_customers.blade.php ENDPATH**/ ?>