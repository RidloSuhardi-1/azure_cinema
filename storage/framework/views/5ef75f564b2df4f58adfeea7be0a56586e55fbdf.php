        ...
        <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <!-- /.col -->
                <form action="<?php echo e(route('customer.search', 'email')); ?>" id="search">
                <div class="col">

                        <div class="input-group input-group-sm float-right" style="width: 180px;">

                            <input type="text" name="keyword" id="search-input" class="form-control float-right" value="<?php echo e($result ?? ''); ?>" placeholder="Search by Email">
                ...
                <div class="col col-3">
                  <select id="searchBy" class="form-control form-control-sm select2">
                    <option value="<?php echo e(route('customer.search', 'username')); ?>" selected="selected">Username</option>
                    <option value="<?php echo e(route('customer.search', 'email')); ?>">Email</option>
                  </select>
                </div>
                <!-- /.col -->
              </div>
          ...
          <table class="table">
            ...
            <tbody>
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $def): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <th scope="row"> <?php echo e($def->id); ?></th>
                    <td><?php echo e($def-> username); ?></td>
                    <td><?php echo e($def->email); ?></td>
                    <td><?php echo e($def -> roles); ?></td>
                    <td>
                    <div class="btn-group">
                          <button onclick="window.location.href = '/customer/id/<?php echo e(Crypt::encrypt($def->id)); ?>/edit';" type="button" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></button>
                          <button type="button" class="btn btn-sm btn-danger" data-id="/customer/id/<?php echo e(Crypt::encrypt($def->id)); ?>/destroy" data-name="<?php echo e($def->username); ?>" data-toggle="modal" data-target="#remove"><i class="far fa-trash-alt"></i></button>
...
<?php echo $__env->make('portal.master.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\azure_cinema\resources\views/manage/user_manage.blade.php ENDPATH**/ ?>